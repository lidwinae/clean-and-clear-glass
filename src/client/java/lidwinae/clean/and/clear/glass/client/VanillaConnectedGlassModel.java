...
public class VanillaConnectedGlassModel extends WrapperBlockStateModel {
    ...
    public VanillaConnectedGlassModel(BlockStateModel wrapped, TextureAtlasSprite material) {
    ...
    public void emitQuads(
        ...
        if (level == EmptyBlockAndTintGetter.INSTANCE) {
    ...
    private static void emitInventoryCube(QuadEmitter emitter, TextureAtlasSprite material) {
