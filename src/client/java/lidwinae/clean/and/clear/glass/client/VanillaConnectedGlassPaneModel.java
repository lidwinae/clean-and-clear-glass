...
public class VanillaConnectedGlassPaneModel extends WrapperBlockStateModel {
    ...
    // Draw configurable center marks just behind the pane's normal edge geometry.
    ...
    public VanillaConnectedGlassPaneModel(BlockStateModel wrapped, Material.Baked edgeMaterial) {
        this(wrapped, edgeMaterial, null);
    }
