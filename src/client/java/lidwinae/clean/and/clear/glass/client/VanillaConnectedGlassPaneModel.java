...
public final class VanillaConnectedGlassPaneModel extends ForwardingBakedModel {
    ...
    public VanillaConnectedGlassPaneModel(BakedModel wrapped, TextureAtlasSprite material) {
