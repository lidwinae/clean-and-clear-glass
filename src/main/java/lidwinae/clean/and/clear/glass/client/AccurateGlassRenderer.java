...
public final class AccurateGlassRenderer {
    ...
    private static final ConcurrentMap<Long, CachedBlock> BLOCKS = new ConcurrentHashMap<Long, CachedBlock>();
    ...
    public static void register() {
        ...
        LOGGER.info("Enabled accurate glass transparency sorting for Sodium 0.2.0 build 4");
    }
    ...
    public static void capture(
        ...
        List<BakedQuad> quads = SodiumQuadAdapter.getAllQuads(model, world, state, pos, seed);
