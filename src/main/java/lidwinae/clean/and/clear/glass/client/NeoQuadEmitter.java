    ...
    NeoQuadEmitter emit() {
        ...
        BakedQuad.MaterialInfo materialInfo =
                new BakedQuad.MaterialInfo(
                        ...
                        -1,
                        // 26.3 uses a direction override instead of a shade flag.
                        // Use the same top-face brightness on every unshaded face;
                        // Minecraft still supplies the normal world light values.
