...
public final class VanillaConnectedGlassPaneModel extends ForwardingBakedModel implements SodiumCompatibleGlassModel {
    ...
    private static boolean connectsInDirection(BlockState state, Direction direction) {
        switch (direction) {
            ...
            case EAST:
                return state.getValue(CrossCollisionBlock.EAST);
            case SOUTH:
                return state.getValue(CrossCollisionBlock.SOUTH);
            case WEST:
                return state.getValue(CrossCollisionBlock.WEST);
            default:
                return true;
        }
    }
    ...
    private static void emitNorthSouthEdgeCapQuad(
        ...
        if (face == Direction.NORTH) {
            emitter.sprite(0, 0, u1, topV)
                    .sprite(1, 0, u1, bottomV)
                    .sprite(2, 0, u0, bottomV)
                    .sprite(3, 0, u0, topV);
        } else {
            emitter.sprite(0, 0, u0, topV)
                    .sprite(1, 0, u0, bottomV)
                    .sprite(2, 0, u1, bottomV)
                    .sprite(3, 0, u1, topV);
        }
    ...
    private static boolean isOuterCap(Direction face, float minX, float minZ, float maxX, float maxZ) {
        ...
        switch (face) {
            case NORTH:
                return minZ <= EPSILON;
            case SOUTH:
                return maxZ >= 1 - EPSILON;
            case WEST:
                return minX <= EPSILON;
            case EAST:
                return maxX >= 1 - EPSILON;
            default:
                return false;
        }
    }
    ...
    private static void applySideUv(
        ...
        if (face == Direction.NORTH) {
            emitter.sprite(0, 0, mapX(maxX, sameWest, sameEast), topV)
                    .sprite(1, 0, mapX(maxX, sameWest, sameEast), bottomV)
                    .sprite(2, 0, mapX(minX, sameWest, sameEast), bottomV)
                    .sprite(3, 0, mapX(minX, sameWest, sameEast), topV);
        } else if (face == Direction.SOUTH) {
            emitter.sprite(0, 0, mapX(minX, sameWest, sameEast), topV)
                    .sprite(1, 0, mapX(minX, sameWest, sameEast), bottomV)
                    .sprite(2, 0, mapX(maxX, sameWest, sameEast), bottomV)
                    .sprite(3, 0, mapX(maxX, sameWest, sameEast), topV);
        } else if (face == Direction.WEST) {
            emitter.sprite(0, 0, mapZ(minZ, sameNorth, sameSouth), topV)
                    .sprite(1, 0, mapZ(minZ, sameNorth, sameSouth), bottomV)
                    .sprite(2, 0, mapZ(maxZ, sameNorth, sameSouth), bottomV)
                    .sprite(3, 0, mapZ(maxZ, sameNorth, sameSouth), topV);
        } else if (face == Direction.EAST) {
            emitter.sprite(0, 0, mapZ(maxZ, sameNorth, sameSouth), topV)
                    .sprite(1, 0, mapZ(maxZ, sameNorth, sameSouth), bottomV)
                    .sprite(2, 0, mapZ(minZ, sameNorth, sameSouth), bottomV)
                    .sprite(3, 0, mapZ(minZ, sameNorth, sameSouth), topV);
        }
    }
