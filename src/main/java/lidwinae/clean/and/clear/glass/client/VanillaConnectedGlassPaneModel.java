...
public final class VanillaConnectedGlassPaneModel extends DelegateBlockStateModel {
    ...
    public VanillaConnectedGlassPaneModel(BlockStateModel wrapped, TextureAtlasSprite material) {
    ...
    public void collectParts(
        ...
        parts.add(emitter.buildPart(edgeMaterial));
    }
