# Clean and Clear Glass - Fabric 1.21.1
...
This branch is built only for Minecraft 1.21.1.
...
Held and inventory items are selected at render time. When the mod is disabled, Minecraft's original block and item models are used. Minecraft 1.21.1 loads the custom item models through its older `models/block` and `models/item` resource system.
